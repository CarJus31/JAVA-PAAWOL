...
public class GuessGame {
	...
	public void startGame() {
		 ...
		 System.out.println("IÕm thinking of a number between 0 and 100...");
		 ...
		 while(true) {
			 ...
			 if (p1isRight || p2isRight || p3isRight || p4isRight || p5isRight) {
				 ...
				 System.out.println("Congratulations to our winner.");
				 System.out.println("Please enter $0.75 to play again!");
